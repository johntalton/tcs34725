...
class Converter {
  ...
  static toWTimingMs(ms, requestedWaitLong) {
    ...
    // until it is nolonger in range.  Then switch to the 12x.
    // todo this behavor can be used for fingerprinting
    ...
    if((waitCount <= 0) || (waitCount > 256)) { throw Error('invlaid wait count: ' + waitCount); }
